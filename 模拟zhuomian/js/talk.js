												...
												'<div class="commentBox">'+
													...
													'<div class="comments_poster_ft">'+
														'<div class="qzaddons">'+
															...
															'<ul>'+
																'<li>'+
																	'<a href="javascript:;"><img src="images/ve100.gif" /></a>'+
																'</li>'+
																'<li>'+
																	'<a href="javascript:;"><img src="images/ve120.gif" /></a>'+
																'</li>'+
																'<li>'+
																	'<a href="javascript:;"><img src="images/ve163.gif" /></a>'+
																'</li>'+
																'<li>'+
																	'<a href="javascript:;"><img src="images/ve144.gif" /></a>'+
																'</li>'+
																'<li>'+
																	'<a href="javascript:;"><img src="images/ve151.gif" /></a>'+
																'</li>'+
																'<li>'+
																	'<a href="javascript:;"><img src="images/ve105.gif" /></a>'+
																'</li>'+
															'</ul>'+
														'</div>'+
												...
												'<div class="mod-quick-comment">'+
													...
													'<div class="line-list">'+
														'<ul class="quick-comment-list">'+
															'<li>'+
																'<a href="javascript:;"><img src="images/e1000007.gif"></a>'+
															'</li>'+
															'<li>'+
																'<a href="javascript:;"><img src="images/e1000008.gif"></a>'+
															'</li>'+
															'<li>'+
																'<a href="javascript:;"><img src="images/e1000013.gif"></a>'+
															'</li>'+
															'<li>'+
																'<a href="javascript:;"><img src="images/e1000013.gif"></a>'+
															'</li>'+
															'<li>'+
																'<a href="javascript:;"><img src="images/e1000018.gif"></a>'+
															'</li>'+
														'</ul>'+
													'</div>'+
												'</div>'+
